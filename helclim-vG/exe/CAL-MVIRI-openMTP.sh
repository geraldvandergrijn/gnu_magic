...
GZPFAD=/cmsaf/cmsaf-rad3/data/MSGraw/openMTP # here are the compressed Meteosat images
 #GZPFAD=$HELHOME/in # here are the compressed Meteosat images
 PFAD=/cmsaf/cmsaf-cld3/tmp_rad/CAL/testdir   # the uncompressed images will be mv to this directory
 #CIPFAD=$HELHOME/out/CI_VIS008  # here are the cloud index output files
CIPFAD=/cmsaf/cmsaf-cld3/tmp_rad/CAL/testdir  # the path of cloud output
GPFAD=/cmsaf/cmsaf-cld3/tmp_rad/CAL/testdir # here are the surface albedo images
