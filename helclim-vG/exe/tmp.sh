...
CIPFAD=/cmsaf/cmsaf-rad2/data/heliosatOUT/delme
GPFAD=/cmsaf/cmsaf-rad2/data/heliosatOUT/delme 
...
$HELHOME/delme.exe -c $CIPFAD -g $GPFAD -l $PFAD/liste -b $PFAD -s -3 -z 0
